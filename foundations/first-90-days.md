...
- **Write your first strength map.** See [People Management Fundamentals]({{ '/people/fundamentals.html' | relative_url }}). Do it privately. It will be wrong — validate it over the next month in 1:1s and skip-levels before trusting it.
...
- **A decision log.** A running doc of the non-trivial decisions you've made and why. Future-you will be grateful. See [Project Execution]({{ '/delivery/project-execution.html' | relative_url }}#decision-making-process) for a template.
